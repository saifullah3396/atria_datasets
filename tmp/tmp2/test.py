...
# }
# path = "s3://testuser12345-cifar10/main/delta/train"
# # path = "s3://datasets/a30c0e2b-3a2f-44cf-8a43-92defb396804/596cfc31-0442-43fe-bcf6-ea63cc2b846b/main/delta/train"
...
# dataset.upload_to_hub(name="cifar10")
# print(dataset)
# indices = []
...
dataset = AtriaHubDataset.load_from_hub(
    ...
    data_dir="./test/",
    dataset_load_mode=DatasetLoadingMode.online_streaming,
)
from torch.utils.data import DataLoader

train_dataloader = DataLoader(
    dataset.train, batch_size=32, shuffle=True, num_workers=0, collate_fn=lambda x: x
)

# Test the DataLoader
print(" Testing DataLoader with AtriaHubDataset...")
